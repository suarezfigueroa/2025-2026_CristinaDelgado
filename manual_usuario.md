...
![Página principal de MeteoPet](img/capturas/landing.png)
...
![Vista de consejos personalizados](img/capturas/consejos.png)
...
![Buscar y gestionar ciudades favoritas](img/gifs/buscar_ciudad.gif)
...
![Publicar un nuevo aviso](img/gifs/nueva_publicacion.gif)
...
![Foro pendiente de moderación](img/capturas/admin_foro.png)
...
![Gestión de mensajes de contacto](img/capturas/admin_mensajes.png)
...
![Añadir nueva ciudad](img/capturas/admin_ciudades.png)
